...
| 19 | `TRANSLATE_LAYER`| **Camada de Tradução Resiliente.** A IA ignora erros de digitação e processa internamente em Shorthand, mas a saída deve ser traduzida para texto amigável em PT-BR. |
---
